...
ENV_VARS = [
    ...
    ("KIBANA_AUTH", "Base64-encoded credentials", "ZWxhc3RpYzpjaGFuZ2VtZQ=="),
    ...
    ("ELASTIC_EVALS_MODEL", "JSON model metadata override", '{"id":"gpt-4","family":"openai","provider":"openai"}'),
    ("ELASTIC_EVALS_TRACING_ENABLED", "Enable tracing (true/false)", "true"),
    ("ELASTIC_EVALS_TRACING_EXPORTER", "Tracing exporter (otlp, console, none)", "otlp"),
    ("ELASTIC_EVALS_TRACING_ENDPOINT", "OTLP HTTP endpoint", "http://localhost:4318/v1/traces"),
