...
"""Prompt templates for correctness evaluation."""

from __future__ import annotations

from typing import Any

PROMPT_NAME = "llm_correctness_evaluation"
PROMPT_DESCRIPTION = "Prompt for evaluating the correctness of LLM responses"
...
USER_PROMPT = """[TASK]
Now, perform the analysis on the following inputs.
                    ...
                    "analysis": {
                        ...
                        "items": {
                            ...
                            "properties": {
                                ...
                                "centrality": {
                                    "type": "string",
                                    "description": "Whether the claim is central or peripheral to answering the user query.",
                                ...
                                "sequence_match": {
                                    "type": "string",
                                    "description": "Whether the claim appears in the correct sequence relative to other claims.",
                                    "enum": ["MATCH", "MISMATCH", "NOT_APPLICABLE"],
                                },
                                "justification_snippet": {
                                    "type": "string",
                                    "nullable": True,
                                    "description": "A direct snippet from the Ground Truth Response supporting the verdict, or null if not applicable.",
                                },
                                "explanation": {
                                    "type": "string",
...
def render_user_prompt(user_query: str, agent_response: str, ground_truth_response: str) -> str:
    return (
        ...
        .replace("{{{ground_truth_response}}}", ground_truth_response)
    )
