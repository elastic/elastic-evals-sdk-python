...
"""Tool call evaluator derived from indexed trace spans."""
...
def create_tool_calls_evaluator(*, trace_client: ElasticsearchTraceClient, log: logging.Logger) -> Evaluator:
    async def evaluate(params: EvaluatorParams) -> EvaluationResult:
        ...
        async def fetch_tool_calls() -> float:
