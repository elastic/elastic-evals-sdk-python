"""Prompt templates for groundedness evaluation."""

from __future__ import annotations

from typing import Any

PROMPT_NAME = "llm_groundedness_evaluation"
PROMPT_DESCRIPTION = "Prompt for evaluating the groundedness of LLM responses"
...
def render_user_prompt(user_query: str, agent_response: str, tool_call_history: str) -> str:
    return (
        ...
        .replace("{{{tool_call_history}}}", tool_call_history)
    )
